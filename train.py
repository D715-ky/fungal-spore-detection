...
def parse_opt(known=False):
    ...
    parser.add_argument('--cfg', type=str, default='models/yolov5s_new.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default=ROOT / 'data/germs.yaml', help='dataset.yaml path')
    parser.add_argument('--hyp', type=str, default=ROOT / 'data/hyps/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--project', default=ROOT / 'runs/yolov5s_new', help='save to project/name')
    ...
    # Quantize
    parser.add_argument('--quantize', action='store_true', default=False, help='run QAT with yolo')
