...
class Conv(nn.Module):
    # Standard convolution [1, 512, 8, 8]
...
class C3(nn.Module):
    ...
    def forward(self, x):
        # print('C3-INPUT==',x.size())  # [1, 512, 16, 16]
...
class MHSA(nn.Module):
    def __init__(self, c, n_dims, width=20, height=20, heads=4):
